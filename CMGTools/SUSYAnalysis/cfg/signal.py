...
#  [TTJets_SingleLeptonFromTbar,TTJets_SingleLeptonFromTbar_ext,TTJets_SingleLeptonFromT,TTJets_DiLepton,TTJets_DiLepton_ext,
  ...
  #  from CMGTools.RootTools.samples.samples_80x_leptonic_signal import *
  if multib: selectedComponents = Vector_MonoTop_NLO_Mphi_1000_Mchi_1_gSM_0p25_gDM_1p0_13TeV_madgraph
  #if multib: selectedComponents = Vector_MonoTop_Leptonic_NLO_Mphi_1000_Mchi_200_gSM_0p25_gDM_1p0_13TeV
  if zerob: selectedComponents = [Vector_MonoTop_Leptonic]
  ...
  if test==1:
    # test a single component, using a single thread.
    #    if multib: comp  = Vector_MonoTop_Leptonic_NLO_Mphi_1000_Mchi_200_gSM_0p25_gDM_1p0_13TeV
    if multib: selectedComponents = Vector_MonoTop_NLO_Mphi_1000_Mchi_1_gSM_0p25_gDM_1p0_13TeV_madgraph
    if zerob: comp  = [Vector_MonoTop_Leptonic]
    comp.files = comp.files[:1]
    selectedComponents = [comp]
    comp.splitFactor = 1
  elif test==2:
