...
susyCoreSequence.insert(susyCoreSequence.index(ttHCoreEventAna), ttHFatJetAna)
...
NIsrAnalyzer = cfg.Analyzer( NIsrAnalyzer, name='NIsrAnalyzer')
## HT skim
...
if sample == "MC":
  ...
  #if multib: selectedComponents = [Scalar_MonoTop_LO_Mphi_1500_Mchi_100_13TeV_madgraph,Scalar_MonoTop_LO_Mphi_1700_Mchi_100_13TeV_madgraph,Scalar_MonoTop_LO_Mphi_1900_Mchi_100_13TeV_madgraph, Scalar_MonoTop_LO_Mphi_2100_Mchi_100_13TeV_madgraph]
  if multib: selectedComponents = [Scalar_MonoTop_LO_Mphi_1500_Mchi_100_13TeV_madgraph]
  ...
  if test==1:
    # test a single component, using a single thread.
#    if multib: comp  = [Scalar_MonoTop_LO_Mphi_1500_Mchi_100_13TeV_madgraph, Scalar_MonoTop_LO_Mphi_1700_Mchi_100_13TeV_madgraph, Scalar_MonoTop_LO_Mphi_1900_Mchi_100_13TeV_madgraph, Scalar_MonoTop_LO_Mphi_2100_Mchi_100_13TeV_madgraph]
    if multib: comp  = [Scalar_MonoTop_LO_Mphi_1500_Mchi_100_13TeV_madgraph]
  ...
  #selectedComponents = [SingleElectron_Run2016B_23Sep2016, SingleElectron_Run2016C_23Sep2016_v1, SingleElectron_Run2016D_23Sep2016_v1, SingleElectron_Run2016E_23Sep2016_v1, SingleElectron_Run2016F_23Sep2016_v1, SingleElectron_Run2016G_23Sep2016_v1]
  ...
  SingleELectrons = [SingleElectron_Run2016B_23Sep2016, SingleElectron_Run2016C_23Sep2016_v1, SingleElectron_Run2016D_23Sep2016_v1, SingleElectron_Run2016E_23Sep2016_v1, SingleElectron_Run2016F_23Sep2016_v1, SingleElectron_Run2016G_23Sep2016_v1, SingleElectron_Run2016H_PromptReco_v1]

  SingleMuons = [SingleMuon_Run2016B_23Sep2016, SingleMuon_Run2016C_23Sep2016_v1, SingleMuon_Run2016D_23Sep2016_v1, SingleMuon_Run2016E_23Sep2016_v1,SingleMuon_Run2016F_23Sep2016_v1, SingleMuon_Run2016G_23Sep2016_v1, SingleMuon_Run2016H_PromptReco_v1]

  selectedComponents = SingleELectrons + SingleMuons
  #  selectedComponents = SingleMuon_03Feb2017 + MET_03Feb2017 + SingleElectron_03Feb2017 + SingleMuon_03Feb2017
  #  selectedComponents = SingleMuon_03Feb2017 + MET_03Feb2017 + SingleElectron_03Feb2017
  
  #selectedComponents =[SingleElectron_Run2016B_23Sep2016]
  #  susyCoreSequence.insert(susyCoreSequence.index(metAna),
  #      [metAnaEGClean, metAnaMuEGClean, metAnaUncorr] )
  #  susyCoreSequence.insert(susyCoreSequence.index(metAna),  metAnaEGClean )
  #  susyCoreSequence.insert(susyCoreSequence.index(metAna),  metAnaMuEGClean )
  #  susyCoreSequence.insert(susyCoreSequence.index(metAna),  metAnaUncorr )
