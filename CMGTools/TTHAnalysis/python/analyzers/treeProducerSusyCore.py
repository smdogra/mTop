...
susyCore_globalObjects = {
            ...
            #"met_EGClean" : NTupleObject("metEGClean", metType, help="PF E_{T}^{miss}, after type 1 corrections (only EG cleaned)"), Sunil
            #"met_MuEGClean" : NTupleObject("metMuEGClean", metType, help="PF E_{T}^{miss}, after type 1 corrections (Muons and EG cleaned)"), Sunil
            #"met_Uncorr" : NTupleObject("metUncorr", metType, help="PF E_{T}^{miss}, after type 1 corrections (no cleaning)"), Sunil
