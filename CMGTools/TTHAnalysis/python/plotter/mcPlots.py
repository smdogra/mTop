                        ...
                        if ext == "txt":
                            ...
                            if "TH2" in total.ClassName() or "TProfile2D" in total.ClassName():
                                ...
                                for p in mca.listSignals(allProcs=True) + mca.listBackgrounds(allProcs=True) + ["signal", "background", "data", "total"]:
                                    ...
                                    #plot.SetMarkerStyle(mca.getProcessOption(p,'MarkerStyle',1)) #  Fixing 2D plots
                                    #plot.SetMarkerColor(mca.getProcessOption(p,'FillColor',ROOT.kBlack)) #  Fixing 2D plots
                                    #plot.Draw(pspec.getOption("PlotMode","COLZ TEXT45"))  #  Fixing 2D plots
