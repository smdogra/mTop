...
# all ttbar, uncomment only for makeBinYields otherwise ttbar will be double counted
TTJets_PDFUnc-RMS{0}                 : TTJets_DiLepton             : Xsec*1*btagSF*nISRttweight*puRatio*lepSF*LHEweight_wgt[{0}]/LHEweight_wgt[0] : lheHTIncoming <= 600
TTJets_PDFUnc-RMS{0}                 : TTJets_SingleLeptonFromT    : Xsec*1*btagSF*nISRttweight*puRatio*lepSF*LHEweight_wgt[{0}]/LHEweight_wgt[0] : lheHTIncoming <= 600
TTJets_PDFUnc-RMS{0}                 : TTJets_SingleLeptonFromTbar : Xsec*1*btagSF*nISRttweight*puRatio*lepSF*LHEweight_wgt[{0}]/LHEweight_wgt[0] : lheHTIncoming <= 600
TTJets_PDFUnc-RMS{0}                 : TTJets_LO_HT600to800        : Xsec*1*btagSF*nISRttweight*puRatio*lepSF*LHEweight_wgt[{0}]/LHEweight_wgt[0] : 1;
TTJets_PDFUnc-RMS{0}                 : TTJets_LO_HT800to1200       : Xsec*1*btagSF*nISRttweight*puRatio*lepSF*LHEweight_wgt[{0}]/LHEweight_wgt[0] : 1;
TTJets_PDFUnc-RMS{0}                 : TTJets_LO_HT1200to2500      : Xsec*1*btagSF*nISRttweight*puRatio*lepSF*LHEweight_wgt[{0}]/LHEweight_wgt[0] : 1;
TTJets_PDFUnc-RMS{0}                 : TTJets_LO_HT2500toInf       : Xsec*1*btagSF*nISRttweight*puRatio*lepSF*LHEweight_wgt[{0}]/LHEweight_wgt[0] : 1;
...
SingleT_PDFUnc-RMS{0} : TBar_tch_powheg          : 80.95*1*btagSF*puRatio*lepSF*LHEweight_wgt[{0}]/LHEweight_wgt[0] ;
SingleT_PDFUnc-RMS{0} : TBar_tWch                : 19.55*1*btagSF*puRatio*lepSF*LHEweight_wgt[{0}]/LHEweight_wgt[0] ;
SingleT_PDFUnc-RMS{0} : T_tWch                   : 19.55*1*btagSF*puRatio*lepSF*LHEweight_wgt[{0}]/LHEweight_wgt[0] ;
...
VV_PDFUnc-RMS{0} : ZZTo2L2Q       : Xsec*1*btagSF*puRatio*lepSF*LHEweight_wgt[{0}]/LHEweight_wgt[0] ;
